...
include '../ConexionesUsuario/Admin.php';
...
<div class="row">
      ...
      <a href="../AdminUsuarios/AdminUsers.php">  <button type="button" class="btn btn-outline-primary">
  ...
  <path fill-rule="evenodd" d="M2 15v-1c0-1 1-4 6-4s6 3 6 4v1H2zm6-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"></path>
      ...
      <a href="../menu/Menu.php">  <button type="button" class="btn btn-outline-primary">
        Editar Menus
